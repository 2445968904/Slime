...
//	bool bDisableAutomaticInteractionPS4 = false;
	...
	*/
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Interaction", meta = (EditCondition = "bOverrideParticleSettings"))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Interaction\|Deprecated", meta = (EditCondition = "bOverrideParticleSettings"/*, Deprecated, DeprecationMessage = "Cascade is deprecated and will be removed in a future release, please use NiagaraInteractionEffect instead."*/))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Damage", meta = (EditCondition = "bOverrideParticleSettings"))
	float DamageEffectScaleMin = 0.4f;
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Damage", meta = (EditCondition = "bOverrideParticleSettings"))
	float DamageEffectScaleMax = 1.0f;
	/** Effect spawned when damage is taken (ie Mortal, bullet hit) */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Damage\|Deprecated", meta = (EditCondition = "bOverrideParticleSettings"/*, Deprecated, DeprecationMessage = "Cascade is deprecated and will be removed in a future release, please use NiagarDamageEffect instead."*/))
	...
	//Niagara param to set scaled damage amount (float) on - Damage amount is remapped from 0-DamageScale to 0-1, where 0 is no damage, and 1 is the max possible damage in game
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "UIWS Interaction Particles\|Particle Overrides\|Damage", meta = (EditCondition = "bOverrideParticleSettings"))
